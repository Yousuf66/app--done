...
const ip = 'http://192.168.100.8:5000'
var imgList = [];
...
var fileList =[];
let addSuspect = (list)=>{
    //this function send the form data to mongoDB along with the urls
 ...
 function fileInput(){
    //this function uploads all the selected files to cloudinary
